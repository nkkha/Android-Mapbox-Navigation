...
public class AnimatedSymbolLayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull MapboxMap map) {
                AnimatedSymbolLayerActivity.this.mapboxMap = map;
                map.setStyle(Style.MAPBOX_STREETS, style -> {
                    AnimatedSymbolLayerActivity.this.style = style;
                    AnimatedSymbolLayerActivity.this.setupCars();
                    AnimatedSymbolLayerActivity.this.animateRandomRoutes();
                    AnimatedSymbolLayerActivity.this.animateTaxi();
                });
            }
        });
    }
    ...
    private void addRandomCars() {
        ...
        style.addImage(RANDOM_CAR_IMAGE_ID,
                ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_arrow_head)).getBitmap());
    ...
    private void addPassenger() {
        ...
        style.addImage(PASSENGER,
                ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_text_icon_24dp)).getBitmap());
    ...
    private void addMainCar() {
        ...
        style.addImage(TAXI,
                ((BitmapDrawable) getResources().getDrawable(R.drawable.ic_arrow_head_casing)).getBitmap());
